<div class="systems index">
	...
	<tr>
		...
		<td><?php echo h($system['System']['acronym']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['description']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['versionnumber']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['created']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['createdby']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['modified']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['modifiedby']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['isactive']); ?>&nbsp;</td>
		<td><?php echo h($system['System']['isdeleted']); ?>&nbsp;</td>
		<td class="actions">
